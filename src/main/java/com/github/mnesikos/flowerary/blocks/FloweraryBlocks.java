...
public final class FloweraryBlocks {
    ...
    static {
        for (String color : Flowerary.COLORS_LIST) {
            ...
            ALYSSUM.put(color, registerWithItem(color + "_alyssum", () -> new FlowerCarpetBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            BROMELIAD.put(color, registerWithItem(color + "_bromeliad", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            CHICORY.put(color, registerWithItem(color + "_chicory", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            HIBISCUS.put(color, registerWithItem(color + "_hibiscus", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            LANTANAS.put(color, registerWithItem(color + "_lantanas", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            POPPIES.put(color, registerWithItem(color + "_poppies", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ROSE_BUSH.put(color, registerWithItem(color + "_rose_bush", () -> new TallFlowerBlock(AbstractBlock.Properties.copy(Blocks.ROSE_BUSH))));
            ROSE_BUSHLET.put(color, registerWithItem(color + "_rose_bushlet", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            WILDFLOWER.put(color, registerWithItem(color + "_wildflower", () -> new FlowerBushBlock(AbstractBlock.Properties.copy(Blocks.POPPY))));
            ...
            ALYSSUM_PLANTS.put(color, REGISTRAR.register(color + "_alyssum_plant", () -> new FlowerCropBlock(FloweraryItems.ALYSSUM_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            BLAZING_STAR_PLANTS.put(color, REGISTRAR.register(color + "_blazing_star_plant", () -> new DoubleFlowerCropBlock.BlazingStarCropBlock(FloweraryItems.BLAZING_STAR_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            CHICORY_PLANTS.put(color, REGISTRAR.register(color + "_chicory_plant", () -> new FlowerCropBlock(FloweraryItems.CHICORY_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            FOXGLOVE_PLANTS.put(color, REGISTRAR.register(color + "_foxglove_plant", () -> new DoubleFlowerCropBlock.FoxgloveCropBlock(FloweraryItems.FOXGLOVE_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            IMPALA_LILY_PLANTS.put(color, REGISTRAR.register(color + "_impala_lily_plant", () -> new DoubleFlowerCropBlock.ImpalaLilyCropBlock(FloweraryItems.IMPALA_LILY_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            LAVENDER_PLANTS.put(color, REGISTRAR.register(color + "_lavender_plant", () -> new DoubleFlowerCropBlock.LavenderCropBlock(FloweraryItems.LAVENDER_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            LILAC_PLANTS.put(color, REGISTRAR.register(color + "_lilac_plant", () -> new DoubleFlowerCropBlock.LilacCropBlock(FloweraryItems.LILAC_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            PEONY_PLANTS.put(color, REGISTRAR.register(color + "_peony_plant", () -> new DoubleFlowerCropBlock.PeonyCropBlock(FloweraryItems.PEONY_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            ROSE_BUSH_PLANTS.put(color, REGISTRAR.register(color + "_rose_bush_plant", () -> new DoubleFlowerCropBlock.RoseBushCropBlock(FloweraryItems.ROSE_BUSH_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
            ...
            SUNFLOWER_PLANTS.put(color, REGISTRAR.register(color + "_sunflower_plant", () -> new DoubleFlowerCropBlock.SunflowerCropBlock(FloweraryItems.SUNFLOWER_SEEDS.get(color), AbstractBlock.Properties.copy(Blocks.WHEAT))));
