...
public final class FloweraryItems {
    ...
    public static final RegistryObject<Item> DANDELION_POLLEN_JAR = REGISTRAR.register("dandelion_pollen_jar", () -> new PollenJarItem(FloweraryColor.YELLOW, new Item.Properties()));
    public static final RegistryObject<Item> POPPY_POLLEN_JAR = REGISTRAR.register("poppy_pollen_jar", () -> new PollenJarItem(FloweraryColor.RED, new Item.Properties()));
    public static final RegistryObject<Item> BLUE_ORCHID_POLLEN_JAR = REGISTRAR.register("blue_orchid_pollen_jar", () -> new PollenJarItem(FloweraryColor.CYAN, new Item.Properties()));
    public static final RegistryObject<Item> ALLIUM_POLLEN_JAR = REGISTRAR.register("allium_pollen_jar", () -> new PollenJarItem(FloweraryColor.MAGENTA, new Item.Properties()));
    public static final RegistryObject<Item> AZURE_BLUET_POLLEN_JAR = REGISTRAR.register("azure_bluet_pollen_jar", () -> new PollenJarItem(FloweraryColor.WHITE, new Item.Properties()));
    public static final RegistryObject<Item> RED_TULIP_POLLEN_JAR = REGISTRAR.register("red_tulip_pollen_jar", () -> new PollenJarItem(FloweraryColor.RED, new Item.Properties()));
    public static final RegistryObject<Item> ORANGE_TULIP_POLLEN_JAR = REGISTRAR.register("orange_tulip_pollen_jar", () -> new PollenJarItem(FloweraryColor.ORANGE, new Item.Properties()));
    public static final RegistryObject<Item> WHITE_TULIP_POLLEN_JAR = REGISTRAR.register("white_tulip_pollen_jar", () -> new PollenJarItem(FloweraryColor.WHITE, new Item.Properties()));
    public static final RegistryObject<Item> PINK_TULIP_POLLEN_JAR = REGISTRAR.register("pink_tulip_pollen_jar", () -> new PollenJarItem(FloweraryColor.PINK, new Item.Properties()));
    public static final RegistryObject<Item> OXEYE_DAISY_POLLEN_JAR = REGISTRAR.register("oxeye_daisy_pollen_jar", () -> new PollenJarItem(FloweraryColor.WHITE, new Item.Properties()));
    public static final RegistryObject<Item> CORNFLOWER_POLLEN_JAR = REGISTRAR.register("cornflower_pollen_jar", () -> new PollenJarItem(FloweraryColor.BLUE, new Item.Properties()));
    public static final RegistryObject<Item> LILY_OF_THE_VALLEY_POLLEN_JAR = REGISTRAR.register("lily_of_the_valley_pollen_jar", () -> new PollenJarItem(FloweraryColor.WHITE, new Item.Properties()));
    public static final RegistryObject<Item> WITHER_ROSE_POLLEN_JAR = REGISTRAR.register("wither_rose_pollen_jar", () -> new PollenJarItem(FloweraryColor.BLACK, new Item.Properties()));
    public static final RegistryObject<Item> SUNFLOWER_POLLEN_JAR = REGISTRAR.register("sunflower_pollen_jar", () -> new PollenJarItem(FloweraryColor.YELLOW, new Item.Properties()));
    public static final RegistryObject<Item> LILAC_POLLEN_JAR = REGISTRAR.register("lilac_pollen_jar", () -> new PollenJarItem(FloweraryColor.LILAC, new Item.Properties()));
    public static final RegistryObject<Item> ROSE_BUSH_POLLEN_JAR = REGISTRAR.register("rose_bush_pollen_jar", () -> new PollenJarItem(FloweraryColor.RED, new Item.Properties()));
    public static final RegistryObject<Item> PEONY_POLLEN_JAR = REGISTRAR.register("peony_pollen_jar", () -> new PollenJarItem(FloweraryColor.PINK, new Item.Properties()));
