...
public final class FloweraryItems {
    ...
    static {
        for (FloweraryColor floweraryColor : FloweraryColor.values()) {
            ...
            ALLIUM_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_allium_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ALLIUM_PLANTS.get(color).get(), new Item.Properties())));
            ALYSSUM_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_alyssum_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ALYSSUM_PLANTS.get(color).get(), new Item.Properties())));
            AZURE_BLUET_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_azure_bluet_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.AZURE_BLUET_PLANTS.get(color).get(), new Item.Properties())));
            BLAZING_STAR_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_blazing_star_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.BLAZING_STAR_PLANTS.get(color).get(), new Item.Properties())));
            BOUGAINVILLEA_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_bougainvillea_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.BOUGAINVILLEA_PLANTS.get(color).get(), new Item.Properties())));
            BROMELIAD_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_bromeliad_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.BROMELIAD_PLANTS.get(color).get(), new Item.Properties())));
            CHICORY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_chicory_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.CHICORY_PLANTS.get(color).get(), new Item.Properties())));
            CLEMATIS_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_clematis_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.CLEMATIS_PLANTS.get(color).get(), new Item.Properties())));
            CLOVER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_clover_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.CLOVER_PLANTS.get(color).get(), new Item.Properties())));
            CORNFLOWER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_cornflower_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.CORNFLOWER_PLANTS.get(color).get(), new Item.Properties())));
            DAFFODIL_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_daffodil_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.DAFFODIL_PLANTS.get(color).get(), new Item.Properties())));
            DAISY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_daisy_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.DAISY_PLANTS.get(color).get(), new Item.Properties())));
            DANDELION_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_dandelion_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.DANDELION_PLANTS.get(color).get(), new Item.Properties())));
            DIANTHUS_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_dianthus_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.DIANTHUS_PLANTS.get(color).get(), new Item.Properties())));
            FAIRY_ROSE_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_fairy_rose_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.FAIRY_ROSE_PLANTS.get(color).get(), new Item.Properties())));
            FOXGLOVE_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_foxglove_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.FOXGLOVE_PLANTS.get(color).get(), new Item.Properties())));
            HIBISCUS_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_hibiscus_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.HIBISCUS_PLANTS.get(color).get(), new Item.Properties())));
            HYACINTH_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_hyacinth_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.HYACINTH_PLANTS.get(color).get(), new Item.Properties())));
            IMPALA_LILY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_impala_lily_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.IMPALA_LILY_PLANTS.get(color).get(), new Item.Properties())));
            JASMINE_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_jasmine_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.JASMINE_PLANTS.get(color).get(), new Item.Properties())));
            LANTANAS_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_lantanas_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.LANTANAS_PLANTS.get(color).get(), new Item.Properties())));
            LAVENDER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_lavender_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.LAVENDER_PLANTS.get(color).get(), new Item.Properties())));
            LILAC_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_lilac_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.LILAC_PLANTS.get(color).get(), new Item.Properties())));
            LILY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_lily_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.LILY_PLANTS.get(color).get(), new Item.Properties())));
            ORCHID_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_orchid_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ORCHID_PLANTS.get(color).get(), new Item.Properties())));
            PEONY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_peony_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.PEONY_PLANTS.get(color).get(), new Item.Properties())));
            PETALS_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_petals_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.PETALS_PLANTS.get(color).get(), new Item.Properties())));
            PITCHER_PLANT_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_pitcher_plant_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.PITCHER_PLANT_PLANTS.get(color).get(), new Item.Properties())));
            POPPY_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_poppy_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.POPPY_PLANTS.get(color).get(), new Item.Properties())));
            POPPIES_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_poppies_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.POPPIES_PLANTS.get(color).get(), new Item.Properties())));
            ROSE_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_rose_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ROSE_PLANTS.get(color).get(), new Item.Properties())));
            ROSE_BUSH_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_rose_bush_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ROSE_BUSH_PLANTS.get(color).get(), new Item.Properties())));
            ROSE_BUSHLET_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_rose_bushlet_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.ROSE_BUSHLET_PLANTS.get(color).get(), new Item.Properties())));
            SUNFLOWER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_sunflower_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.SUNFLOWER_PLANTS.get(color).get(), new Item.Properties())));
            TORCHFLOWER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_torchflower_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.TORCHFLOWER_PLANTS.get(color).get(), new Item.Properties())));
            TULIP_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_tulip_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.TULIP_PLANTS.get(color).get(), new Item.Properties())));
            WILDFLOWER_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_wildflower_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.WILDFLOWER_PLANTS.get(color).get(), new Item.Properties())));
            WITHER_ROSE_SEEDS.put(color, TABLESS_REGISTRAR.register(color + "_wither_rose_seeds", () -> new SeedsJarBlockItem(FloweraryBlocks.WITHER_ROSE_PLANTS.get(color).get(), new Item.Properties())));
        }
    }
}