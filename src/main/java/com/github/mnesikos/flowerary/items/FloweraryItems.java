...
public final class FloweraryItems {
    ...
    public static final RegistryObject<Item> BLUE_ORCHID_POLLEN_JAR = REGISTRAR.register("blue_orchid_pollen_jar", () -> new PollenJarItem("cyan", new Item.Properties().tab(Flowerary.FLOWERARY_GROUP)));
    ...
    public static final RegistryObject<Item> OXEYE_DAISY_POLLEN_JAR = REGISTRAR.register("oxeye_daisy_pollen_jar", () -> new PollenJarItem("white", new Item.Properties().tab(Flowerary.FLOWERARY_GROUP)));
    ...
    public static final RegistryObject<Item> ROSE_BUSH_POLLEN_JAR = REGISTRAR.register("rose_bush_pollen_jar", () -> new PollenJarItem("red", new Item.Properties().tab(Flowerary.FLOWERARY_GROUP)));
