...
public class PollenJarBlueItem extends Item {
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (player != null && !world.isClientSide) {
            ...
            else if (state.getBlock().equals(BLUE_ORCHID)) crop = FloweraryBlocks.BLUE_CLEMATIS_PLANT.get();
            else if (state.getBlock().equals(ALLIUM)) crop = FloweraryBlocks.BLUE_ALLIUM_PLANT.get();
            else if (state.getBlock().equals(AZURE_BLUET)) crop = FloweraryBlocks.BLUE_CLOVER_PLANT.get();
            else if (state.getBlock().equals(RED_TULIP)) crop = FloweraryBlocks.BLUE_HYACINTH_PLANT.get();
            else if (state.getBlock().equals(ORANGE_TULIP)) crop = FloweraryBlocks.BLUE_HYACINTH_PLANT.get();
            else if (state.getBlock().equals(WHITE_TULIP)) crop = FloweraryBlocks.BLUE_HYACINTH_PLANT.get();
            else if (state.getBlock().equals(PINK_TULIP)) crop = FloweraryBlocks.BLUE_HYACINTH_PLANT.get();
            else if (state.getBlock().equals(OXEYE_DAISY)) crop = FloweraryBlocks.BLUE_DAISY_PLANT.get();
            else if (state.getBlock().equals(CORNFLOWER)) crop = FloweraryBlocks.BLUE_DIANTHUS_PLANT.get();
            else if (state.getBlock().equals(LILY_OF_THE_VALLEY)) crop = FloweraryBlocks.BLUE_BOUGAINVILLEA_PLANT.get();
            else if (state.getBlock().equals(WITHER_ROSE)) crop = FloweraryBlocks.BLUE_FAIRY_ROSE_PLANT.get();
            else if (state.getBlock().equals(SUNFLOWER)) crop = FloweraryBlocks.BLUE_SUNFLOWER_PLANT.get();
            else if (state.getBlock().equals(LILAC)) crop = FloweraryBlocks.BLUE_JASMINE_PLANT.get();
            else if (state.getBlock().equals(PEONY)) crop = FloweraryBlocks.BLUE_FOXGLOVE_PLANT.get();
            else if (state.getBlock().equals(ALLIUM)) crop = FloweraryBlocks.BLUE_ALLIUM_PLANT.get();
