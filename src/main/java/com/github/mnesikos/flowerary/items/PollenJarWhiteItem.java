        ...
        if (blockstate.getBlock().equals(ROSE_BUSH) || blockstate.getBlock().equals(WITHER_ROSE) || blockstate.getBlock().equals(DANDELION) || blockstate.getBlock().equals(POPPY) ||
            ...
            if (!world.isClientSide) {
                ...
                if (blockstate.getBlock().equals(ROSE_BUSH)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_ROSE.get());
                } else if (blockstate.getBlock().equals(DANDELION)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_DANDELION.get());
                } else if (blockstate.getBlock().equals(POPPY)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_POPPY.get());
                } else if (blockstate.getBlock().equals(BLUE_ORCHID)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_ORCHID.get());
                } else if (blockstate.getBlock().equals(ALLIUM)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_ALLIUM.get());
                } else if (blockstate.getBlock().equals(AZURE_BLUET)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_AZURE_BLUET.get());
                } else if (blockstate.getBlock().equals(RED_TULIP)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_TULIP.get());
                    ...
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_DAISY.get());
                } else if (blockstate.getBlock().equals(CORNFLOWER)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_CORNFLOWER.get());
                } else if (blockstate.getBlock().equals(LILY_OF_THE_VALLEY)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_LILY.get());
                } else if (blockstate.getBlock().equals(WITHER_ROSE)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_WITHER_ROSE.get());
                } else if (blockstate.getBlock().equals(SUNFLOWER)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_SUNFLOWER.get());
                } else if (blockstate.getBlock().equals(LILAC)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_LILAC.get());
                } else if (blockstate.getBlock().equals(PEONY)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_PEONY.get());
                } else if (blockstate.getBlock().equals(ALLIUM)) {
                    net.minecraft.entity.item.ItemEntity ent = player.spawnAtLocation(FloweraryBlocks.CROP_WHITE_ALLIUM.get());
                }
